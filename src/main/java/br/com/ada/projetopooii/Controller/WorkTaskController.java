...
public class WorkTaskController {
    ...
    private TaskRepository<WorkTask> taskRepository;
    Scanner scanner = new Scanner(System.in);

    public WorkTaskController(TaskRepository<WorkTask> taskRepository) {
    ...
    public void addTask() {
        ...
        WorkTask task = new WorkTask(nextId, nome, descricao, prazoEmDias);
    ...
    public void deleteTask(){
        scanner.nextLine();
        System.out.println("------ Deletando Tarefa de Trabalho ------ \n" +
